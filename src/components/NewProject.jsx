...
export default function NewProject({onAdd, onCancel}){
    ...
    return(
        <>
        <Model ref={model} buttonCaption="Close"><h2 className="text-xl font-bold text-stone-700 my-4">Invalid Input</h2>
        <p className='text-stone-600 mb-4'>Opps ... looks like you forgot to enter a value.</p>
        <p className='text-stone-600 mb-4'>Please provide all the values.</p>
        </Model>
